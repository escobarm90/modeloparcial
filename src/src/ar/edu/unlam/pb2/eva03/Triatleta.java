...
public class Triatleta extends Deportista implements ICorredor, INadador{
	...
	public Triatleta(int numeroDeSocio, String nombre, String distanciaPreferida, TipoDeBicicleta tipoDeBicicleta) {
		super(numeroDeSocio, nombre);
		this.distanciaPreferida = distanciaPreferida;
		this.TIPO_DE_BICICLETA = tipoDeBicicleta;
	}
